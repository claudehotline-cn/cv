...
def get_corpus_dir(article_id: str, doc_id: str, task_id: str = "main") -> str:
...
async def ensure_corpus_dir(article_id: str, doc_id: str, task_id: str = "main") -> Tuple[str, str]:
    ...
    """
    corpus_dir = get_corpus_dir(article_id, doc_id, task_id)
...
def load_article_artifact(article_id: str, artifact_name: str, task_id: str = "main") -> Dict[str, Any]:
...
def save_article_artifact(article_id: str, artifact_name: str, data: Dict[str, Any], task_id: str = "main") -> str:
...
def save_draft_file(article_id: str, section_id: str, content: str, task_id: str = "main") -> str:
    """保存草稿文件 (.md)。"""
    if not article_id:
        return ""
...
def find_draft_files(article_id: str, task_id: str = "main") -> List[str]:
    """查找文章的所有草稿文件。"""
    if not article_id:
        return []
