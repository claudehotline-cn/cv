...
- 协议与接口：
  - `docs/design/subscription_pipeline/VSM_REST_SSE与指标配置.md`
  - `docs/design/subscription_pipeline/webrtc-protocol.md`
  - `docs/design/subscription_pipeline/控制面错误码与语义.md`
- 订阅与训练：
