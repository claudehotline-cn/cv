...
- 推理与引擎：`docs/design/subscription_pipeline/tensorrt_engine.md`、`docs/design/subscription_pipeline/triton_inprocess_integration.md`
- 性能与保护：见本说明书第 6 章“非功能性与调试建议”
- YOLO/NMS 与多阶段图：`docs/design/subscription_pipeline/multistage_graph_详细设计.md`
