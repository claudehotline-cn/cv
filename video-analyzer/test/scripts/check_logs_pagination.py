#!/usr/bin/env python3
"""Check /api/logs pagination with time window.

Usage:
  python check_logs_pagination.py --base http://127.0.0.1:8082 --mins 30
"""
...
def main(argv: Iterable[str]) -> int:
    ap = argparse.ArgumentParser(description="Check /api/logs pagination")
    ...
    url = f"{base}/api/logs?from_ts={frm}&to_ts={now}&page={args.page}&page_size={args.page_size}"
